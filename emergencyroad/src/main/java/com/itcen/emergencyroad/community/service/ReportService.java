...
public class ReportService {
    ...
    @Transactional
    public void createReport(Long reporterId, ReportTargetType targetType, Long targetId){
        ...
        Report newReport = Report.createReport(reporter, targetType, targetId); // 신고자 이름, 신고 대상을 적음
